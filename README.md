...
- dApp, DeFi, NFT
- Solidity, Qt, C, Python
- Ethereum, Bitcoin, Avalanche, Polygon, Binance Smart Chain, Chainlink
- Algorithmic Trading
- ElectronJS, POS(Point of Sale), C# WPF XAML UWP, React, Vue, Angular, Javascript/Typescript, Node.js, Web3.js, Ethers.js,  GraphQL, ...

As a senior blockchain developer with 4+ years of experience in Solidity,  I used to work on several DeFi and NFT projects.

- What blockchain networks I’ve worked with?   : Ethereum,  Avalanche,  Polygon,  BSC (Binance Smart Chain),  
- What languages/frameworks/libraries I’m experienced with?  :  Solidity,  Web3.js, Ethers.js,  Typescript/JavaScript, Vue.js, React.js, Qt, GraphQL,  …   
